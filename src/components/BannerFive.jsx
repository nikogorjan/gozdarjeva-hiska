                        ...
                        <div className="banner-inner position-relative">
                            <div className="banner-content">
                                ...
                                <div className="banner-content__button">
                                    <Link to="https://www.booking.com/hotel/si/gozdarjeva-hiska-m-amp-k.sl.html?aid=356980&label=Share-ekKMUUa%401739115847" className="btn btn-main fw-normal">{t('re')}
